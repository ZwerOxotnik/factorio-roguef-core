...
local function explosion(name, count, x, y, speed, blend)
	if blend == false then
		return {
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/" .. name .. ".png",
					frame_count = count,
					width = x,
					height = y,
...
data:extend({
	...
	explosion("shot-3", 8, 16, 16, 60, false), explosion("shot-13", 8, 16, 16, 60, false),
		explosion("firstaid", 2, 32, 32, 4, true), {
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/recall.png",
					frame_count = 30,
					line_length = 5,
					width = 192,
					height = 192,
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/target-elec.png",
					frame_count = 8,
					line_length = 2,
					width = 32,
					height = 16,
			...
			sound = {
				...
				variations = {{filename = "__roguef-core__/sound/target-elec.ogg", volume = 0.3}}
			}
		}, {
			type = "explosion",
			name = "target-elec-1",
			...
			sound = {
				aggregation = {max_count = 1, remove = true},
				variations = {{filename = "__roguef-core__/sound/target-melee.ogg", volume = 0.75}}
			}
		}, {
			type = "explosion",
			name = "target-melee-1",
			...
			sound = {
				aggregation = {max_count = 1, remove = true},
				variations = {{filename = "__roguef-core__/sound/target-melee.ogg", volume = 0.5}}
			}
		}, {
			type = "explosion",
			name = "target-melee-2",
			...
			sound = {
				aggregation = {max_count = 1, remove = true},
				variations = {{filename = "__roguef-core__/sound/target-melee.ogg", volume = 0.2}}
			}
		}, {
			type = "explosion",
			name = "target-poison",
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/target-poison.png",
					frame_count = 25,
					line_length = 5,
					width = 64,
					height = 64,
			...
			sound = {
				aggregation = {max_count = 1, remove = true},
				variations = {{filename = "__roguef-core__/sound/target-poison.ogg", volume = 0.5}}
			}
		}, {
			type = "explosion",
			name = "target-blood",
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/target-blood.png",
					frame_count = 25,
					line_length = 5,
					width = 64,
					height = 64,
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/target-water.png",
					frame_count = 20,
					line_length = 5,
					width = 64,
					height = 64,
			...
			sound = {
				aggregation = {max_count = 1, remove = true},
				variations = {{filename = "__roguef-core__/sound/target-water.ogg", volume = 0.2}}
			}
		}, {
			type = "explosion",
			name = "target-slash",
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/target-slash.png",
					frame_count = 10,
					line_length = 5,
					width = 64,
					height = 64,
			...
			sound = {
				aggregation = {max_count = 1, remove = true},
				variations = {{filename = "__roguef-core__/sound/shot-9.ogg", volume = 0.3}}
			}
		}, {
			type = "explosion",
			name = "slash-22",
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/slash-22.png",
					frame_count = 30,
					line_length = 5,
					width = 192,
					height = 192,
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/target-ice.png",
					frame_count = 15,
					line_length = 5,
					width = 64,
					height = 64,
			...
			sound = {
				aggregation = {max_count = 1, remove = true},
				variations = {{filename = "__roguef-core__/sound/target-ice.ogg", volume = 0.5}}
			}
		}, {
			type = "explosion",
			name = "target-fire",
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/target-fire.png",
					frame_count = 12,
					width = 48,
					height = 48,
			...
			sound = {
				aggregation = {max_count = 1, remove = true},
				variations = {{filename = "__roguef-core__/sound/target-fire.ogg", volume = 1}}
			}
		}, {
			type = "explosion",
			name = "target-fire-1",
			...
			sound = {
				aggregation = {max_count = 1, remove = true},
				variations = {{filename = "__roguef-core__/sound/target-fire.ogg", volume = 0.75}}
			}
		}, {
			type = "explosion",
			name = "explosion",
		...
		}, -- TODO: CHECK THIS!!!
		{
			...
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/emp.png",
					frame_count = 24,
					line_length = 8,
					width = 128,
					height = 128,
	...
	data:extend({
		{
			...
			icon = "__roguef-core__/graphics/explosion/ex.png",
			icon_size = 32,
			subgroup = "rf_enemy",
			order = "z",
			...
			pictures = {{filename = "__roguef-core__/graphics/explosion/ex-" .. i .. ".png", width = i, height = i}}
		}, {
			type = "explosion",
			name = "explosion-" .. i,
			flags = {"not-on-map", "placeable-off-grid"},
			animations = {
				{
					filename = "__roguef-core__/graphics/explosion/explosion.png",
					priority = "extra-high",
					width = 40,
					height = 40,
					shift = {0, 1},
...
data:extend({
	{
		...
		animation = {
			filename = "__roguef-core__/graphics/explosion/13-1.png",
			frame_count = 1,
			width = 15,
			height = 20,
			priority = "high",
		...
		animation = {
			filename = "__roguef-core__/graphics/explosion/13-2.png",
			frame_count = 2,
			width = 30,
			height = 31,
			priority = "high",
